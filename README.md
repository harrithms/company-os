...
skills/ is what makes the rest of it multiplayer
  ...
  run-a-one-to-one        the weekly and the monthly, asking different questions
  ...
  review-customer-signal  what customers actually said, counted, reaching the plan
  onboard-someone         from a start date to genuinely useful, in the right order
